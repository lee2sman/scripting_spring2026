...
Let's get some streaming audio links. There is a free API called Radio Browser, with full [documentation](https://radio-browser.info). The data is available as JSON values.
