...
### For next week: Create a Personal site of dreams, fears, a map, what to eat, OR clouds you have known
...
* favorite clouds
* OR do you have another idea you'd rather make? Then do that.

This is to practice making a **compelling, interesting** website. 

Spend time on this. Polish it. Make it interesting.

Browse the [gallery of website](https://neocities.org/browse) on Neocities (warning: this is all user-created and all kinds of content could be there. Use your discretion before clicking random links.) 
